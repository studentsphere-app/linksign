...
description: Example of Microsoft OAuth authentication in linksign.
---

Here is a full working example from the source repository showing how to implement **Microsoft OAuth** authentication.
...
import { loginWithMicrosoft, verifyPin } from "@studentsphere/linksign";
