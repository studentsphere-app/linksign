---
title: Whitelabel
description: Example of Whitelabel authentication in linksign.
---

Here is a full working example from the source repository showing how to implement **Whitelabel** authentication.
