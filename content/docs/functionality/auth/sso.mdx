---
title: SSO
description: Example of SSO authentication in linksign.
---

Here is a full working example from the source repository showing how to implement **SSO** authentication.
